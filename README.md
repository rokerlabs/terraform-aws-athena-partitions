...
Athena partitions will alow you run queries against specific date, reducing query cost and execution time. Example logs query using date partitions:
```SQL
...
![Athena Partitions Architecture](docs/assets/architecture.png)
